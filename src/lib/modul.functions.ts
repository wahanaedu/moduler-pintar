...
5. praktikPedagogis: jelaskan MODEL PEMBELAJARAN untuk SETIAP pertemuan (jika ${form.jumlahPertemuan} > 1 gunakan model yang dapat berbeda dan saling melengkapi, mis. Problem Based Learning untuk pertemuan 1 dan Station Rotation / Discovery Learning / Project Based Learning untuk pertemuan berikutnya). Format WAJIB berupa DAFTAR BULLET dengan tanda "- ", satu bullet per pertemuan mengikuti pola persis:
   "- Pertemuan 1 menggunakan model <Nama Model> : (1) <sintaks 1>, (2) <sintaks 2>, (3) <sintaks 3>, (4) <sintaks 4>, (5) <sintaks 5>."
   Tambahkan satu bullet terakhir "- Strategi Pembelajaran: <strategi ringkas yang relevan dengan '${form.materi}'>". Semua sintaks HARUS spesifik & aplikatif ke sub-materi tiap pertemuan, bukan definisi umum.
...
10. pertemuanData: TEPAT ${form.jumlahPertemuan} objek berurutan 1..${form.jumlahPertemuan}. Setiap objek WAJIB punya field pertemuan berupa angka (1, 2, 3, dst.). Setiap pertemuan HARUS berbeda topik/sub-materi dan bertahap (scaffolded) menuju penguasaan "${form.materi}".
   ...
   - inti (45–60 menit): tulis sebagai BEBERAPA FASE mengikuti sintaks model yang dipakai pertemuan itu. Format WAJIB per fase:
     Baris judul fase (paragraf sendiri, TIDAK diawali angka/bullet): "Fase <n> – <Nama Fase> (<Pengalaman>: <prinsip1, prinsip2>)" — contoh persis: "Fase 1 – Orientasi Masalah (Memahami: berkesadaran)".
     Diikuti 3–6 baris aktivitas berupa BULLET DIAWALI TANDA "- " (bukan angka) yang menuliskan langkah konkret guru/siswa, alat/media, dan pertanyaan pemantik bila ada.
     Ulangi pola tersebut untuk seluruh fase model. Pengalaman yang dipakai: Memahami, Mengaplikasi, atau Merefleksi. Prinsip yang tersedia: berkesadaran, bermakna, menggembirakan (boleh gabungan 2). Padukan sintaks "${form.modelPembelajaran}" bila hanya 1 pertemuan.
